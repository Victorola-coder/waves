...
export default function Dashboard() {
  ...
  const quickActions = [
    { title: "Create Room", icon: Plus, action: "create-room" },
    { title: "Join Room", icon: Users, action: "join-room" },
    { title: "Find Friends", icon: Search, action: "find-friends" },
    { title: "Leaderboard", icon: TrendingUp, action: "leaderboard" },
  ];
      ...
      >
        <div className="relative max-w-md">
          ...
          <Input
            ...
            className="pl-10 bg-neutral-700/60 border-neutral-600/30"
          />
        </div>
      </motion.div>
      ...
      >
        {statsLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="bg-gradient-to-br from-neutral-500/20 to-neutral-500/10 border-neutral-500/30">
              <div className="p-6">
                <div className="flex items-center justify-between">
                  <div>
            ...
            >
              <Card className="bg-neutral-800/50 border-neutral-600/30 hover:border-primary/50 transition-all duration-300">
                <div className="p-4 text-center">
                  <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-gradient-to-r from-primary to-secondary flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
        ...
        >
          ...
          <Card className="bg-neutral-800/50 border-neutral-600/30">
            <div className="p-6 space-y-4">
              ...
              <div className="flex items-center justify-between">
                <span className="text-neutral-300">Total Memberships</span>
                <span className="text-white font-semibold">
                  {userStats?.totalMemberships || 0}
                </span>
              </div>
