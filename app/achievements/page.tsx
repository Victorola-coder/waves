...
export default function Achievements() {
  ...
  const categories = [
    ...
    { value: 'listening', label: 'Listening', icon: Music, color: 'text-green-500' },
    { value: 'social', label: 'Social', icon: Users, color: 'text-blue-500' },
    { value: 'hosting', label: 'Hosting', icon: Crown, color: 'text-purple-500' },
      ...
      <header className="border-b border-neutral-700/50 bg-neutral-900/80 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-6">
          <div className="text-center">
            ...
            <p className="text-neutral-400 text-lg">Unlock your musical potential</p>
          </div>
        </div>
      </header>
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <Card className="bg-gradient-to-br from-primary/20 to-primary/10 border-primary/30">
              <div className="p-6 text-center">
                ...
                <p className="text-sm text-neutral-400">of {achievements.length}</p>
              </div>
            </Card>
          ...
          <Card className="bg-neutral-800/50 border-neutral-600/30">
            <div className="p-6">
              <div className="flex flex-col md:flex-row md:items-center justify-between space-y-4 md:space-y-0">
                {/* Categories */}
                <div>
                  <label className="block text-sm font-medium text-neutral-300 mb-3">Categories</label>
                ...
                {/* Sort */}
                <div>
                  <label className="block text-sm font-medium text-neutral-300 mb-3">Sort By</label>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <div className={`flex items-center space-x-1 ${rarityColors[achievement.rarity]}`}>
                          <rarityIcons[achievement.rarity] className="w-4 h-4" />
                          <span className="text-xs font-medium uppercase">{achievement.rarity}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-neutral-400">XP Reward:</span>
                        <span className="text-sm font-semibold text-yellow-500">+{achievement.xpReward}</span>
                      </div>
                    </div>
        ...
        {sortedAchievements.length === 0 && (
          ...
          >
            ...
            <p className="text-neutral-400">Try adjusting your filters or categories</p>
          </motion.div>
        )}
      </div>
    </div>
